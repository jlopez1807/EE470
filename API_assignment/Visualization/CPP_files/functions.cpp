...
String url = "https://script.google.com/macros/s/AKfycbxfzPjnAr4dvKMe1XbAFzAow3XTzdDl66JphGTBODu9cfjOrb_uLrMSZIBGv-a8PHkh0g/exec";
...
void transmitData(float temperature, float humidity) {
    ...
    Serial.println("Full URL: " + fullUrl);  // Add this line
